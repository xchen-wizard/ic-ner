...
class JointTODBERT(BertPreTrainedModel):
    def __init__(self, config, args, intent_labels_dict, slot_labels_dict):
        super().__init__(config)
        self.args = args
        self.num_intent_labels = len(intent_labels_dict)
        self.num_slot_labels = len(slot_labels_dict)
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, intent_label_ids, slot_labels_ids):
        ...
        intent_logits, slot_logits = None, None
        total_loss = 0
        # 1. Intent Softmax
